export default function Intro() {
    ...
    return (
        <section
            id="intro"
            className="min-h-screen flex items-center pt-20 pb-16 px-6 max-w-5xl mx-auto"
        >
            <div className="flex flex-col-reverse lg:flex-row items-center gap-12 w-full">
                ...
                <div className="flex-1 space-y-6">
                    {/* Eyebrow */}
                    <p className="font-mono text-xs tracking-widest text-primary uppercase opacity-70">
                        // sobre mim
                    </p>
                    ...
                    {/* Contatos */}
                    <div id="contato" className="flex flex-wrap gap-3 pt-2">
                        <a
                            href="https://github.com/gustasvos"
                            target="_blank"
